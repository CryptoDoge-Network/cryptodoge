...
"""
run_block: Convert an encoded FullBlock from the Cryptodoge blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../cryptodoge/types/full_block.py) in json format
...
$ca_root is the directory containing your current Cryptodoge config files
$hash is the header_hash of the [BlockRecord](../cryptodoge/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../cryptodoge/types/condition_opcodes.py)
...
from cryptodoge.full_node.generator import create_generator_args
...
from cryptodoge.wallet.cat_wallet.cat_utils import match_cat_puzzle
