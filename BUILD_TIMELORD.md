...
required to run a [Timelord](https://github.com/Cryptodoge-Network/cryptodoge/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Cryptodoge-Network/cryptodoge/blob/main/install-timelord.sh)
