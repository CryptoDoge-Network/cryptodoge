...
from cryptodoge.consensus.network_type import NetworkType
from cryptodoge.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from cryptodoge.farmer.farmer import Farmer
from cryptodoge.protocols import farmer_protocol, harvester_protocol
from cryptodoge.protocols.harvester_protocol import PoolDifficulty
...
from cryptodoge.util.api_decorators import api_request, peer_required
                ...
                try:
                    async with aiohttp.ClientSession() as session:
                        async with session.post(
                            ...
                            headers={"User-Agent": f"Cryptodoge Blockchain v.{__version__}"},
                        ) as resp:
                            if resp.ok:
