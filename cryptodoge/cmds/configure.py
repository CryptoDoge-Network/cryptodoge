...
from cryptodoge.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.cryptodoge.cc"
            testnet_dns_introducer = "dns-introducer-testnet7.cryptodoge.cc"
            testnet = "testnet7"
    ...
    if change_made:
        print("Restart any running cryptodoge services for changes to take effect")
