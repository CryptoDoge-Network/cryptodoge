...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Cryptodoge versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Cryptodoge keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (xcd for mainnet, txcd for testnet)", default=None, type=str)
@click.option(
    "--non-observer-derivation",
    "-d",
