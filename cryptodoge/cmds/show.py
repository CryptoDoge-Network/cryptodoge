...
from cryptodoge.util.network import is_trusted_inner
    ...
    try:
        ...
        if state:
            ...
            if synced:
                ...
                print("You may be able to expedite with 'cryptodoge show -a host:port' using a known node.\n")
        ...
        if add_connection:
            if ":" not in add_connection:
                print("Enter a valid IP and port in the following format: 10.5.4.3:16690")
            else:
                ip, port = (
