...
from cryptodoge.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total cryptodoge farmed: {amounts['farmed_amount'] / units['cryptodoge']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['cryptodoge']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['cryptodoge']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'cryptodoge start wallet' and 'cryptodoge wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'cryptodoge wallet show'")
    else:
        print("Note: log into your key using 'cryptodoge wallet show' to see rewards for each key")
