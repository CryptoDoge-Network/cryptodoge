...
from cryptodoge.consensus.block_rewards import calculate_base_farmer_reward
from cryptodoge.pools.pool_wallet import PoolWallet
from cryptodoge.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from cryptodoge.protocols.protocol_message_types import ProtocolMessageTypes
from cryptodoge.server.outbound_message import NodeType, make_msg
...
from cryptodoge.util.ints import uint32, uint64, uint8
from cryptodoge.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from cryptodoge.util.path import path_from_root
from cryptodoge.util.ws_message import WsRpcMessage, create_payload_dict
...
from cryptodoge.wallet.derive_keys import master_sk_to_singleton_owner_sk, master_sk_to_wallet_sk_unhardened, MAX_POOL_WALLETS
from cryptodoge.wallet.rl_wallet.rl_wallet import RLWallet
from cryptodoge.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
from cryptodoge.wallet.util.wallet_types import AmountWithPuzzlehash, WalletType
from cryptodoge.wallet.wallet_info import WalletInfo
from cryptodoge.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "cryptodoge_wallet"
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cat_wallet":
            ...
            if request["mode"] == "new":
                ...
                from cryptodoge.pools.pool_wallet_info import initial_pool_state_from_dict
