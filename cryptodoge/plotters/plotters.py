...
from cryptodoge.plotters.bladebit import get_bladebit_install_info, plot_bladebit
from cryptodoge.plotters.chiapos import get_chiapos_install_info, plot_chia
from cryptodoge.plotters.madmax import get_madmax_install_info, plot_madmax
from cryptodoge.plotters.install_plotter import install_plotter
...
def call_plotters(root_path: Path, args):
    # Add `plotters` section in CRYPTODOGE_ROOT.
    cryptodoge_root_path = root_path
    ...
    if not os.path.exists(root_path):
        print(f"Creating plotters folder within CRYPTODOGE_ROOT: {root_path}")
        try:
            os.mkdir(root_path)
        except Exception as e:
    ...
    build_parser(subparsers, root_path, cryptodoge_plotter, "chiapos", "Chiapos Plotter")
    ...
    if args.plotter == "chiapos":
        plot_chia(args, cryptodoge_root_path)
    if args.plotter == "madmax":
        plot_madmax(args, cryptodoge_root_path, root_path)
    if args.plotter == "bladebit":
        plot_bladebit(args, cryptodoge_root_path, root_path)
