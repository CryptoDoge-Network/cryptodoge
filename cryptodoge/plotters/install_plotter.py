import os
from cryptodoge.plotters.bladebit import install_bladebit
from cryptodoge.plotters.madmax import install_madmax
...
def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        ...
        if not os.path.exists(root_path / "madmax-plotter/build/cryptodoge_plot"):
