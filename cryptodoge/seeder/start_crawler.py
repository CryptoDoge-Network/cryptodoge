...
from cryptodoge.rpc.crawler_rpc_api import CrawlerRpcApi
from cryptodoge.seeder.crawler import Crawler
from cryptodoge.seeder.crawler_api import CrawlerAPI
...
def service_kwargs_for_full_node_crawler(
    ...
    if config.get("crawler", {}).get("start_rpc_server", True):
        kwargs["rpc_info"] = (CrawlerRpcApi, config.get("crawler", {}).get("rpc_port", 19561))
