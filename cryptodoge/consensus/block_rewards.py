...
def calculate_base_farmer_reward(height: uint32) -> uint64:
    ...
    The base fee reward is 3/8 of total block reward
    ...
    """
    if height == 0:
        return uint64(int((1 / 8) * 21000000000 * _mojo_per_cryptodoge))
    elif height < 3 * _blocks_per_year:
        return uint64(int((1 / 8) * 2 * 10000 * _mojo_per_cryptodoge))
    elif height < 6 * _blocks_per_year:
        return uint64(int((1 / 8) * 1 * 10000 * _mojo_per_cryptodoge))
    elif height < 9 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.5 * 10000 * _mojo_per_cryptodoge))
    elif height < 12 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.25 * 10000 * _mojo_per_cryptodoge))
    elif height < 15 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.125 * 10000 * _mojo_per_cryptodoge))
    elif height < 18 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.0625 * 10000 * _mojo_per_cryptodoge))
    elif height < 21 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.03125 * 10000 * _mojo_per_cryptodoge))
    elif height < 24 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.015625 * 10000 * _mojo_per_cryptodoge))
    elif height < 27 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.0078125 * 10000 * _mojo_per_cryptodoge))
    elif height < 30 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.00390625 * 10000 * _mojo_per_cryptodoge))
    elif height < 99 * _blocks_per_year:
        return uint64(int((1 / 8) * 50 * _mojo_per_cryptodoge))
    else:
        return uint64(0)
