...
from cryptodoge.consensus.cost_calculator import NPCResult, calculate_cost_of_program
...
from cryptodoge.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
