...
from cryptodoge.consensus.block_creation import create_unfinished_block
from cryptodoge.consensus.block_record import BlockRecord
from cryptodoge.consensus.pot_iterations import calculate_ip_iters, calculate_iterations_quality, calculate_sp_iters
from cryptodoge.full_node.bundle_tools import best_solution_generator_from_template, simple_solution_generator
from cryptodoge.full_node.full_node import FullNode
...
from cryptodoge.protocols import farmer_protocol, full_node_protocol, introducer_protocol, timelord_protocol, wallet_protocol
from cryptodoge.protocols.full_node_protocol import RejectBlock, RejectBlocks
from cryptodoge.protocols.protocol_message_types import ProtocolMessageTypes
from cryptodoge.protocols.wallet_protocol import PuzzleSolutionResponse, RejectHeaderBlocks, RejectHeaderRequest
from cryptodoge.server.outbound_message import Message, make_msg
...
from cryptodoge.util.api_decorators import api_request, peer_required, bytes_required, execute_task
        ...
        async with self.full_node.timelord_lock:
            ...
            if prev_b is None:
                ...
                if request.proof_of_space.pool_contract_puzzle_hash is not None:
                    #ignore pool_contract_puzzle_hash
