...
from cryptodoge.full_node.generator import create_compressed_generator
from cryptodoge.types.blockchain_format.program import SerializedProgram, Program
