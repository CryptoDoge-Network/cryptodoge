...
from cryptodoge.consensus.coinbase import pool_parent_id, farmer_parent_id
from cryptodoge.consensus.constants import ConsensusConstants
from cryptodoge.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from cryptodoge.pools.pool_wallet import PoolWallet
from cryptodoge.protocols import wallet_protocol
from cryptodoge.protocols.wallet_protocol import PuzzleSolutionResponse, RespondPuzzleSolution, CoinState
...
from cryptodoge.util.config import process_config_start_method
from cryptodoge.util.db_wrapper import DBWrapper
from cryptodoge.util.errors import Err
from cryptodoge.util.ints import uint32, uint64, uint128, uint8
from cryptodoge.util.db_synchronous import db_synchronous_on
from cryptodoge.wallet.cat_wallet.cat_utils import match_cat_puzzle, construct_cat_puzzle
from cryptodoge.wallet.cat_wallet.cat_wallet import CATWallet
from cryptodoge.wallet.cat_wallet.cat_constants import DEFAULT_CATS
from cryptodoge.wallet.derivation_record import DerivationRecord
from cryptodoge.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from cryptodoge.wallet.key_val_store import KeyValStore
from cryptodoge.wallet.puzzles.cat_loader import CAT_MOD
from cryptodoge.wallet.rl_wallet.rl_wallet import RLWallet
from cryptodoge.wallet.settings.user_settings import UserSettings
from cryptodoge.wallet.trade_manager import TradeManager
from cryptodoge.wallet.transaction_record import TransactionRecord
from cryptodoge.wallet.util.compute_hints import compute_coin_hints
from cryptodoge.wallet.util.transaction_type import TransactionType
from cryptodoge.wallet.util.wallet_sync_utils import last_change_height_cs
from cryptodoge.wallet.util.wallet_types import WalletType
from cryptodoge.wallet.wallet import Wallet
from cryptodoge.wallet.wallet_action import WalletAction
from cryptodoge.wallet.wallet_action_store import WalletActionStore
from cryptodoge.wallet.wallet_blockchain import WalletBlockchain
from cryptodoge.wallet.wallet_coin_record import WalletCoinRecord
from cryptodoge.wallet.wallet_coin_store import WalletCoinStore
from cryptodoge.wallet.wallet_info import WalletInfo
...
from cryptodoge.wallet.wallet_puzzle_store import WalletPuzzleStore
from cryptodoge.wallet.wallet_sync_store import WalletSyncStore
from cryptodoge.wallet.wallet_transaction_store import WalletTransactionStore
from cryptodoge.wallet.wallet_user_store import WalletUserStore
from cryptodoge.server.server import CryptodogeServer
from cryptodoge.wallet.did_wallet.did_wallet import DIDWallet
from cryptodoge.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def fetch_parent_and_check_for_cat(
        self, peer: WSCryptodogeConnection, coin_state: CoinState, fork_height: Optional[uint32]
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSCryptodogeConnection, fork_height: Optional[uint32]
    ) -> None:
