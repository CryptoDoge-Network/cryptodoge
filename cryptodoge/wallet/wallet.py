...
from cryptodoge.wallet.sign_coin_spends import sign_coin_spends
...
from cryptodoge.wallet.util.wallet_types import WalletType, AmountWithPuzzlehash
    ...
    async def create_spend_bundle_relative_cryptodoge(self, cryptodoge_amount: int, exclude: List[Coin]) -> SpendBundle:
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries: List[AmountWithPuzzlehash] = [
                    {"puzzlehash": newpuzhash, "amount": uint64(cryptodoge_amount), "memos": []}
                ]
