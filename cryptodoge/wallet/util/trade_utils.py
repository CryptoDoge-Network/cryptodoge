...
from cryptodoge.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "cryptodoge" in cc_discrepancies:
                    cc_discrepancies["cryptodoge"] = cc_discrepancies["cryptodoge"] + diff
                else:
                    cc_discrepancies["cryptodoge"] = diff
