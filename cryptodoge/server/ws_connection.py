...
from cryptodoge.cmds.init_funcs import cryptodoge_full_version_str
from cryptodoge.protocols.protocol_message_types import ProtocolMessageTypes
from cryptodoge.protocols.protocol_state_machine import message_response_ok
from cryptodoge.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from cryptodoge.protocols.shared_protocol import Capability, Handshake
...
from cryptodoge.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from cryptodoge.util.network import class_for_type, is_localhost
