...
from cryptodoge.daemon.server import singleton, service_launch_lock_path
from cryptodoge.server.ssl_context import cryptodoge_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"cryptodoge_{service_name_prefix}{service_name}"
        ...
        cryptodoge_ca_crt, cryptodoge_ca_key = cryptodoge_ssl_ca_paths(root_path, self.config)
        ...
        self._server = CryptodogeServer(
            ...
            (cryptodoge_ca_crt, cryptodoge_ca_key),
