  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of cryptodoge in the blockchain at the current
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send cryptodoge to coloured address. Please enter a cryptodoge
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'cryptodoge_addr://') {
    ...
    const amountValue = Number.parseFloat(cryptodoge_to_mojo(amount));
    const feeValue = Number.parseFloat(cryptodoge_to_mojo(fee));
