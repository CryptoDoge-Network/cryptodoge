...
import { AlertDialog, Card, Flex } from '@cryptodoge/core';
import {
  send_transaction,
  rl_set_user_info_action,
} from '../../../modules/message';
import { mojo_to_cryptodoge_string, cryptodoge_to_mojo } from '../../../util/cryptodoge';
...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const cryptodogeper_input = ip_parsed.limit;
    ...
    const cryptodogeper_value = Number.parseInt(Number(cryptodogeper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (cryptodoge per interval):{' '}
                  {mojo_to_cryptodoge_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_cryptodoge_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const SendCard = (props) => {
  ...
  function send() {
    ...
    const fee = cryptodoge_to_mojo(fee_input.value);
