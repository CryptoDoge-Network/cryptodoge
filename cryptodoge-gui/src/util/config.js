...
global.daemon_rpc_ws = `wss://${self_hostname}:57690`;
  ...
  try {
    ...
    const config_root_dir =
      'CRYPTODOGE_ROOT' in process.env
        ...
        : path.join(os.homedir(), '.cryptodoge', net);
    ...
    const daemon_port = lodash.get(config, 'ui.daemon_port', 57690); // jshint ignore:line
