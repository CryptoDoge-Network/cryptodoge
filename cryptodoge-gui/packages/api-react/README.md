# @cryptodoge/api-react

![Alt text](https://www.cryptodoge.cc/img/cryptodoge_logo.svg)

This library provides react hooks on the top of @cryptodoge/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Cryptodoge Blockchain).
...
import { useGetPublicKeysQuery } from '@cryptodoge/api-react';
...
import { store, api } from '@cryptodoge/api-react';
