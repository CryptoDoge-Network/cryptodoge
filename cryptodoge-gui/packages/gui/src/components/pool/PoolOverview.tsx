...
import { Flex, UnitFormat, More, Table, mojoToCryptodogeLocaleString, Suspender } from '@cryptodoge/core';
...
import { WalletStatus } from '@cryptodoge/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToCryptodogeLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
