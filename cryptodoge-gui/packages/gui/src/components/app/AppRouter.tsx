...
import { SelectKey, LayoutHero, LayoutMain, LayoutDashboard, Mode, useMode } from '@cryptodoge/core';
import { WalletAdd, WalletImport, Wallets } from '@cryptodoge/wallets';
        ...
        <Route path="/" element={<AppProviders outlet />}>
          ...
          {mode === Mode.WALLET ? (
            ...
            <Route element={<LayoutDashboard settings={<SettingsPanel />} sidebar={<DashboardSideBar />} outlet />}>
              ...
              <Route path="dashboard/gamefi/*" element={<Gamefi />} />
