...
import { AlertDialog, Flex, useOpenDialog, Suspender, useValidateChangePassphraseParams } from '@cryptodoge/core';
import { useGetKeyringStatusQuery, useRemoveKeyringPassphraseMutation, useSetKeyringPassphraseMutation } from '@cryptodoge/api-react';
      ...
      <DialogContent>
        ...
        {!!canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. Cryptodoge will be able to access your keys without prompting for your passphrase.`}>
