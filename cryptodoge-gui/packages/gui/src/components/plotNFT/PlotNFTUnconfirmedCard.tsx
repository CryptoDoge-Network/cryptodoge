...
import { Flex, Link, Loading } from '@cryptodoge/core';
import { useGetTransactionQuery } from '@cryptodoge/api-react';
import { Box, Card, CardContent, Typography } from '@material-ui/core';
import type { UnconfirmedPlotNFT } from '@cryptodoge/api';
