...
import { Plot as PlotIcon } from '@cryptodoge/icons';
import { useDeleteUnconfirmedTransactionsMutation } from '@cryptodoge/api-react';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: (
        <UnitFormat
          value={mojoToCryptodogeLocaleString(balance)}
          state={State.SUCCESS}
        />
      ),
    },
