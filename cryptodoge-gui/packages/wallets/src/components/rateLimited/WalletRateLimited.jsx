...
import { AlertDialog, Card, Flex, cryptodogeToMojo, mojoToCryptodogeLocaleString } from '@cryptodoge/core';
import {
  send_transaction,
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  ...
                  {mojoToCryptodogeLocaleString(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojoToCryptodogeLocaleString(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const SendCard = (props) => {
  ...
  function send() {
    ...
    const amount = cryptodogeToMojo(amount_input.value);
    const fee = cryptodogeToMojo(fee_input.value);
