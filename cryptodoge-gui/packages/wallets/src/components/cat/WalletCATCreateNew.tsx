...
import { cryptodogeToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@cryptodoge/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = cryptodogeToMojo(amount || '0');
      const feeMojos = cryptodogeToMojo(fee || '0');
