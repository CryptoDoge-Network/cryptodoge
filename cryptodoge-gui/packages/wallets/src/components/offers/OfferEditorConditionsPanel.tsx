...
import { useGetWalletBalanceQuery, useGetWalletsQuery } from '@cryptodoge/api-react';
import { Wallet, WalletType } from '@cryptodoge/api';
    ...
    if (!isLoading && tradeSide === 'sell' && walletBalance && walletBalance.walletId == row.assetWalletId) {
      switch (item.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToCryptodogeLocaleString(walletBalance.spendableBalance);
          balance = mojoToCryptodoge(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
