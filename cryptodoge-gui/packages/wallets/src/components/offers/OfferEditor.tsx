...
import { useCreateOfferForIdsMutation } from '@cryptodoge/api-react';
import {
  Button,
  Divider,
  Grid,
...
import { cryptodogeToMojo, catToMojo } from '@cryptodoge/core';
import fs from 'fs';
  ...
  function updateOffer(offer: { [key: string]: number | string }, row: OfferEditorRowData, debit: boolean) {
    ...
    if (assetWalletId > 0) {
      ...
      if (walletType === WalletType.STANDARD_WALLET) {
        mojoAmount = Number.parseFloat(cryptodogeToMojo(amount));
      }
