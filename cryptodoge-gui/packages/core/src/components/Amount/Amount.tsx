...
import cryptodogeToMojo from '../../utils/cryptodogeToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isCryptodogeCurrency = ['XCD', 'TXCD'].includes(currencyCode);
  const mojo = isCryptodogeCurrency
    ? cryptodogeToMojo(correctedValue)
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isCryptodogeCurrency ? 6 : 3,
          },
          endAdornment: (
