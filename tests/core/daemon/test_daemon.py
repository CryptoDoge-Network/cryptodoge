...
from cryptodoge.daemon.server import WebSocketServer
...
from cryptodoge.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, self_hostname, simulation, bt, get_b_tools, get_b_tools_1):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "cryptodoge_full_node")
        await ws.send_str(payload)
