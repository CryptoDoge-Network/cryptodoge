...
from cryptodoge.protocols import farmer_protocol
from cryptodoge.rpc.farmer_rpc_api import FarmerRpcApi
from cryptodoge.rpc.farmer_rpc_client import FarmerRpcClient
from cryptodoge.rpc.harvester_rpc_api import HarvesterRpcApi
...
async def test_farmer_reward_target_endpoints(bt, environment):
    ...
    await farmer_rpc_client.set_reward_targets(encode_puzzle_hash(new_ph, "xcd"), encode_puzzle_hash(new_ph_2, "xcd"))
    ...
    await farmer_rpc_client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xcd"))
