...
from cryptodoge.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from cryptodoge.protocols import wallet_protocol, full_node_protocol
...
from cryptodoge.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
from cryptodoge.server.outbound_message import NodeType
from cryptodoge.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
class TestSimpleSyncProtocol:
    ...
    async def test_subscribe_for_ph(self, wallet_node_simulator, self_hostname):
        ...
        from cryptodoge.wallet.puzzles.singleton_top_layer import SINGLETON_LAUNCHER_HASH
