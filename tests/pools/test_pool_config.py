...
from cryptodoge.pools.pool_config import PoolWalletConfig
from cryptodoge.util.config import load_config, save_config, create_default_cryptodoge_config
...
def test_pool_config():
    ...
    create_default_cryptodoge_config(test_root, ["config.yaml"])
