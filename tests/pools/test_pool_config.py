...
from cryprotdoge.pools.pool_config import PoolWalletConfig
from cryprotdoge.util.config import load_config, save_config, create_default_cryprotdoge_config
...
def test_pool_config():
    ...
    create_default_cryprotdoge_config(test_root, ["config.yaml"])
