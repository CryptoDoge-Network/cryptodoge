...
from cryptodoge.types.weight_proof import WeightProof, SubEpochData, SubEpochChallengeSegment, SubSlotData, RecentChainData
...
from cryptodoge.types.peer_info import TimestampedPeerInfo
from cryptodoge.types.blockchain_format.reward_chain_block import RewardChainBlock
from cryptodoge.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, FoliageBlockData, TransactionsInfo

from cryptodoge.protocols import (
    farmer_protocol,
    full_node_protocol,
    harvester_protocol,
    introducer_protocol,
...
timestamped_peer_info = TimestampedPeerInfo("127.0.0.1", uint16(15994), uint64(10796))
