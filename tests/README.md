...
The workflows are located in [../.github/workflows/](https://github.com/Cryprotdoge-Network/cryprotdoge-blockchain/tree/main/.github/workflows).
...
In the top tests directory, [testconfig.py](https://github.com/Cryprotdoge-Network/cryprotdoge-blockchain/tree/main/tests/testconfig.py)
...
Set `checkout_blocks_and_plots` to `False` to omit checking out the [test-cache](https://github.com/Cryprotdoge-Network/test-cache) repo.
