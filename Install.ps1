...
Write-Output "For assistance join us on Discord in the #testnet chat channel:"
Write-Output "https://discord.gg/invite/qK2x5zFUNx"
Write-Output ""
Write-Output "Try the Quick Start Guide to running cryptodoge:"
...
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'cryptodoge init' to begin."
