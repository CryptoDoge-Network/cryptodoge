...
kwargs = dict(
    ...
    keywords="cryptodoge blockchain node",
    ...
    entry_points={
        "console_scripts": [
            ...
            "cryptodoge_crawler = cryptodoge.seeder.start_crawler:main",
            "cryptodoge_seeder = cryptodoge.seeder.dns_server:main",
